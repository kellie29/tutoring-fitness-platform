/**
 * @flow
 * @relayHash 8d8372199c56ec58663bcff6500b1311
 */
...
export type TableIDFilterInput = {|
  ...
  eq?: ?string,
|};
export type ProgramModuleFilterSelectViewQueryVariables = {|
  filter?: ?ProgramModuleFilterInput
|};
export type ProgramModuleFilterSelectViewQueryResponse = {|
  +$fragmentRefs: ProgramModuleFilterSelectViewList_query$ref
|};
export type ProgramModuleFilterSelectViewQuery = {|
  variables: ProgramModuleFilterSelectViewQueryVariables,
  response: ProgramModuleFilterSelectViewQueryResponse,
|};
*/


/*
query ProgramModuleFilterSelectViewQuery(
  $filter: ProgramModuleFilterInput
) {
  ...ProgramModuleFilterSelectViewList_query_Vt7Yj
}
...
fragment ProgramModuleFilterSelectViewList_query_Vt7Yj on Query {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "ProgramModuleFilterSelectViewQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "ProgramModuleFilterSelectViewQuery",
    "id": null,
    "text": "query ProgramModuleFilterSelectViewQuery(\n  $filter: ProgramModuleFilterInput\n) {\n  ...ProgramModuleFilterSelectViewList_query_Vt7Yj\n}\n\nfragment NodeListItem_node on Node {\n  ...NodeListItem_presentable\n  ... on Owned {\n    owner {\n      __typename\n      ...PresentableAvatar_presentable\n      ...PresentableLink_presentable\n      ... on Presentable {\n        name\n      }\n      id\n    }\n  }\n  createdAt\n}\n\nfragment NodeListItem_presentable on Presentable {\n  presentableTypeName: __typename\n  ...PresentableAvatar_presentable\n  ...PresentableCardMedia_presentable\n  name\n  image {\n    url\n    id\n  }\n  description\n}\n\nfragment PresentableAvatar_presentable on Presentable {\n  name\n  image {\n    url\n    id\n  }\n}\n\nfragment PresentableCardMedia_presentable on Presentable {\n  ...PresentableAvatar_presentable\n  name\n  image {\n    url\n    id\n  }\n}\n\nfragment PresentableLink_presentable on Presentable {\n  __typename\n  id\n  name\n}\n\nfragment ProgramModuleFilterSelectViewListRow_programModule on ProgramModule {\n  ...NodeListItem_node\n  id\n  isPublic\n}\n\nfragment ProgramModuleFilterSelectViewList_query_Vt7Yj on Query {\n  programModules(filter: $filter, first: 10) {\n    edges {\n      node {\n        ...ProgramModuleFilterSelectViewListRow_programModule\n        id\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '39d52ffd44a951db605c08c2a75147e3';
module.exports = node;
