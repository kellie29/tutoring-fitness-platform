/**
 * @flow
 * @relayHash 9f0fe2ef38fbc53968e1741cb0bf7ae8
 */
...
export type UserGroupFilterInput = {|
  ...
  userId?: ?string,
|};
export type UserGroupListPaginationQueryVariables = {|
  filter?: ?UserGroupFilterInput,
  count: number,
  cursor?: ?string,
|};
export type UserGroupListPaginationQueryResponse = {|
  +$fragmentRefs: UserGroupList_query$ref
|};
export type UserGroupListPaginationQuery = {|
  variables: UserGroupListPaginationQueryVariables,
  response: UserGroupListPaginationQueryResponse,
|};
*/


/*
query UserGroupListPaginationQuery(
  $filter: UserGroupFilterInput
  $count: Int!
  $cursor: ID
) {
  ...UserGroupList_query_3KQYpM
}
...
fragment UserGroupList_query_3KQYpM on Query {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "UserGroupListPaginationQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "UserGroupListPaginationQuery",
    "id": null,
    "text": "query UserGroupListPaginationQuery(\n  $filter: UserGroupFilterInput\n  $count: Int!\n  $cursor: ID\n) {\n  ...UserGroupList_query_3KQYpM\n}\n\nfragment NodeListItem_node on Node {\n  ...NodeListItem_presentable\n  ... on Owned {\n    owner {\n      __typename\n      ...PresentableAvatar_presentable\n      ...PresentableLink_presentable\n      ... on Presentable {\n        name\n      }\n      id\n    }\n  }\n  createdAt\n}\n\nfragment NodeListItem_presentable on Presentable {\n  presentableTypeName: __typename\n  ...PresentableAvatar_presentable\n  ...PresentableCardMedia_presentable\n  name\n  image {\n    url\n    id\n  }\n  description\n}\n\nfragment PresentableAvatar_presentable on Presentable {\n  name\n  image {\n    url\n    id\n  }\n}\n\nfragment PresentableCardMedia_presentable on Presentable {\n  ...PresentableAvatar_presentable\n  name\n  image {\n    url\n    id\n  }\n}\n\nfragment PresentableLink_presentable on Presentable {\n  __typename\n  id\n  name\n}\n\nfragment UserGroupList_query_3KQYpM on Query {\n  userGroups(filter: $filter, first: $count, after: $cursor) {\n    edges {\n      node {\n        ...UserGroupRow_userGroup\n        id\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n\nfragment UserGroupRow_userGroup on UserGroup {\n  ...NodeListItem_node\n  id\n  members(first: 0) {\n    edgeCount\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'b21a269305f202a42bb575e96e95611a';
module.exports = node;
