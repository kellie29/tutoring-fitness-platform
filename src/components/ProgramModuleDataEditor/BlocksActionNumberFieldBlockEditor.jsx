...
import { type BlocksActionNumberFieldBlock } from '../../helpers/programModuleData';
...
type Props = {
  data: BlocksActionNumberFieldBlock | null,
  onChange: (data: BlocksActionNumberFieldBlock | null) => void,
};

export default function BlocksActionNumberFieldBlockEditor(props: Props) {
