/**
 * @flow
 * @relayHash b69aac697307c681520b1664a7f7f106
 */
...
export type TableIDFilterInput = {|
  ...
  eq?: ?string,
|};
export type ProgramModuleListPaginationQueryVariables = {|
  filter?: ?ProgramModuleFilterInput,
  count: number,
  cursor?: ?string,
|};
export type ProgramModuleListPaginationQueryResponse = {|
  +$fragmentRefs: ProgramModuleList_query$ref
|};
export type ProgramModuleListPaginationQuery = {|
  variables: ProgramModuleListPaginationQueryVariables,
  response: ProgramModuleListPaginationQueryResponse,
|};
*/
...
query ProgramModuleListPaginationQuery(
  ...
  ...ProgramModuleList_query_3KQYpM
}
...
fragment ProgramModuleList_query_3KQYpM on Query {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "ProgramModuleListPaginationQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "ProgramModuleListPaginationQuery",
    "id": null,
    "text": "query ProgramModuleListPaginationQuery(\n  $filter: ProgramModuleFilterInput\n  $count: Int!\n  $cursor: ID\n) {\n  ...ProgramModuleList_query_3KQYpM\n}\n\nfragment NodeListItem_node on Node {\n  ...NodeListItem_presentable\n  ... on Owned {\n    owner {\n      __typename\n      ...PresentableAvatar_presentable\n      ...PresentableLink_presentable\n      ... on Presentable {\n        name\n      }\n      id\n    }\n  }\n  createdAt\n}\n\nfragment NodeListItem_presentable on Presentable {\n  presentableTypeName: __typename\n  ...PresentableAvatar_presentable\n  ...PresentableCardMedia_presentable\n  name\n  image {\n    url\n    id\n  }\n  description\n}\n\nfragment PresentableAvatar_presentable on Presentable {\n  name\n  image {\n    url\n    id\n  }\n}\n\nfragment PresentableCardMedia_presentable on Presentable {\n  ...PresentableAvatar_presentable\n  name\n  image {\n    url\n    id\n  }\n}\n\nfragment PresentableLink_presentable on Presentable {\n  __typename\n  id\n  name\n}\n\nfragment ProgramModuleList_query_3KQYpM on Query {\n  programModules(filter: $filter, first: $count, after: $cursor) {\n    edges {\n      node {\n        ...ProgramModuleRow_programModule\n        id\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n\nfragment ProgramModuleRow_programModule on ProgramModule {\n  ...NodeListItem_node\n  id\n  isPublic\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = '945f4c7fe816d3bce2d02ff6bfd04cd9';
module.exports = node;
