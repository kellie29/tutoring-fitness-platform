/**
 * @flow
 * @relayHash df995c5bb321e5b284ab2891286f49e1
 */
...
export type UserViewPageTracksTabQueryVariables = {|
  userId?: ?string
|};
export type UserViewPageTracksTabQueryResponse = {|
  +user: ?{|
    +id: string,
    +name: string,
    +tracks: {|
  ...
  |}
|};
export type UserViewPageTracksTabQuery = {|
  variables: UserViewPageTracksTabQueryVariables,
  response: UserViewPageTracksTabQueryResponse,
|};
*/


/*
query UserViewPageTracksTabQuery(
  $userId: ID
) {
  user(id: $userId) {
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "UserViewPageTracksTabQuery",
    "type": "Query",
    "metadata": null,
  ...
  "params": {
    ...
    "name": "UserViewPageTracksTabQuery",
    "id": null,
    "text": "query UserViewPageTracksTabQuery(\n  $userId: ID\n) {\n  user(id: $userId) {\n    ...PresentableViewPageHeader_presentable\n    id\n    name\n    tracks(first: 10) {\n      edges {\n        node {\n          ...ProgramTrackRow_programTrack\n          id\n        }\n      }\n    }\n  }\n}\n\nfragment PresentableAvatar_presentable on Presentable {\n  name\n  image {\n    url\n    id\n  }\n}\n\nfragment PresentableLink_presentable on Presentable {\n  __typename\n  id\n  name\n}\n\nfragment PresentableTag_presentable on Presentable {\n  ...PresentableAvatar_presentable\n  __typename\n  id\n  name\n}\n\nfragment PresentableViewPageHeader_presentable on Presentable {\n  ...PresentableAvatar_presentable\n  name\n  image {\n    url\n    width\n    height\n    id\n  }\n  ... on Owned {\n    owner {\n      __typename\n      ...PresentableLink_presentable\n      id\n    }\n  }\n}\n\nfragment ProgramTrackRow_programTrack on ProgramTrack {\n  id\n  startDate\n  user {\n    ...PresentableTag_presentable\n    id\n  }\n}\n",
    "metadata": {}
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'b03dbb7b2af044323267397f1b5ba301';
module.exports = node;
